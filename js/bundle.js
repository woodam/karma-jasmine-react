...
/***/ function(module, exports, __webpack_require__) {
	...
	var optionList = {
	    people: [{ firstName: "우담", lastName: "지" }, { firstName: "정애", lastName: "곽" }, { firstName: "동섭", lastName: "이" }]
	};

	_reactDom2["default"].render(_react2["default"].createElement(_top2["default"], { top: topData }), document.getElementById('top'));

	_reactDom2["default"].render(_react2["default"].createElement("listApp", { list: optionList.people }), document.getElementById('list'));
